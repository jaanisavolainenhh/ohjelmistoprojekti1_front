...
import KyselyValinta from './components/KyselyValinta';
      ...
      <Router>
        <div>
          ...
          <Switch>
            ...
            <Route exact path="/"
              render={(props) => <KyselyValinta {...props} urlit={urlit} />} />
            <Route exact path="/kyselyvalinta"
